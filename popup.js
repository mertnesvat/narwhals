            ...
            success: function(data) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        //now json variable contains data in json formatw
                        //let's display a few items
                        //$('#results').html('Plugin name: ' + json.events[0].ticket_url + '<br />Author: ' + json.results);
                        $.each(json.events, function(index, value) {
                            $('#inner').append("<li><img src=\"" + json.events[index].images.square.path + "\" class=\"img\">" + "<div class=\"text\" > " + json.events[index].name + "</div></li>").bind('click', function() {
                                console.log('2');
